...
# カンマ演算子
# =============================================================================
assert_inline 3 'return (1, 2, 3);'  # 最後の式の値を返す
assert_inline 5 'int x; return (x = 3, x + 2);'  # 左辺で代入、右辺で計算
assert_inline 10 'int x; int y; return (x = 3, y = 7, x + y);'  # 複数の代入と計算
assert_inline 4 'int x; x = 1; return (x++, x++, x++, x);'  # 副作用の確認
assert_inline 7 'int a; int b; a = (b = 5, b + 2); return a;'  # 代入式内でカンマ
